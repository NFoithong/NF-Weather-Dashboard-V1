// var apiKey = "570577608c6e63cd2a8db048c380cdd1"
...
function populateCityWeather(city, citySearchList) {
    ...
    var queryURL =
        "https://api.openweathermap.org/data/2.5/weather?&units=imperial&appid=570577608c6e63cd2a8db048c380cdd1&q=" +
        city;

    var queryURL2 =
        "https://api.openweathermap.org/data/2.5/forecast?&units=imperial&appid=570577608c6e63cd2a8db048c380cdd1&q=" +
        city;
    ...
    $.ajax({
        ...
        .then(function(weather) {
            ...
            var queryURL3 =
                "https://api.openweathermap.org/data/2.5/uvi/forecast?&units=imperial&appid=570577608c6e63cd2a8db048c380cdd1&q=" +
                "&lat=" +
                latitude +
                "&lon=" +
                longitude;
